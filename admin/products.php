...
if(isset($_POST['add_product'])){
   ...
   if($select_products->rowCount() > 0){
      ...
      $total_stock = ($fetch_products['stock'] - $qty);
      if ($qty > $fetch_p['stock']) {
         $warning_msg[] = 'Only '.$fetch_products['stock'].' stock is left';
      }else{
...
<section class="add-products">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      <div class="flex">
         ...
         <div class="inputBox">
         <span>total stock (required) </span>
...
<section class="show-products">
   ...
   <div class="box">
      ...
      <div class="price">MK<span><?= $fetch_products['price']; ?></span>/-</div>
